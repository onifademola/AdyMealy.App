...
namespace EBZ.Mobile.Services
{
    public class GenericService : IGenericService
    {
        ...
        public async Task<AuthenticationResponse> DoAuthAsync<T>(string uri)
        {
            if (_connectionService.IsConnected)
            {
                try
                {
                    ...
                    var jsonR = JsonConvert.DeserializeObject<AuthenticationResponse>(null);
                    return jsonR;
                }
                catch (Exception e)
                {
        ...
        public async Task<String> GetStringAsync<T>(string uri)
        {
            if (_connectionService.IsConnected)
            {
                try
                {
                    ...
                    var jsResult = await responseMessage.Content.ReadAsStringAsync().ConfigureAwait(false);
